...
public class MarketoClient {
  ...
  public int getEmailTemplateIdByName(MarketingContext marketingContext, NewsletterContext newsletterContext, String token, String title) throws IOException {
    String endpoint = marketingContext.getProperty(ENDPOINT) + MessageFormat.format(getEmailTemplateUrl, title);
    ...
    throw new IOException("Failed to get mail template '" + title + ", status " + urlConn.getResponseCode());
  }
  ...
  @Required
  public void setGetEmailTemplateUrl(String getEmailTemplateUrl) {
    this.getEmailTemplateUrl = getEmailTemplateUrl;
  }
}
